...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    ...
    <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/signup-bg.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>Register</h1>
            <span class="subheading">New? Come And Register</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="signup_try.php" method="post">
    ...
    <div class="form-group row">
      ...
      <input type="text" name="txtName" class="form-control col-sm-3" placeholder="Name" required>
      <div class="col-sm-5"></div>
    </div>
    <div class="form-group row">
      <div class="col-lg-12"></div>
      <div class="col-sm-4"></div>
      <input type="Email" name="txtEmail" class="form-control col-sm-3" placeholder="Email" required="true">
      <div class="col-sm-5"></div>
    </div>
    <div class="form-group row">
      <div class="col-lg-12"></div>
    ...
    <div class="form-group row">
      <div class="col-sm-4"></div>
        <input type="password" name="txtPass" class="form-control col-sm-3" placeholder="Password" required="true">
      <div class="col-sm-5"></div>
    </div>
