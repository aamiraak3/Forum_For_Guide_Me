...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/Project/Forum/index.php">Forum</a>
          </li>
          <li class="nav-item">
  ...
  <form action="login_try.php" method="post">
    ...
    <div class="form-group row">
      ...
      <input type="text" name="txtUser" class="form-control col-sm-3" placeholder="User Name" required="true">
