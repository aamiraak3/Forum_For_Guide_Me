...
<head>
    ...
    <title>Guide Me Forum | New PM</title>
    <!-- ///////////////////////////////////////////// -->
    <meta charset="utf-8">
...
<!-- /////////////////////////////////////// -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item">
            <a class="nav-link" href="read_pm.php">Read Pm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="list_pm.php">\list Pm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="profile.php">Profile</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="new_pm.php">New Messages</a>
        </li>
        <li class="nav-item">
