...
{
	$id = intval($_GET['id']);
	$dn1 = $con->query('select count(id) as nb1, name, position from categories where id="'.$id.'" group by id')->fetch_assoc();
	// print_r($dn1);
	if($dn1['nb1']>0)
	{
    ...
    <title>Guide Me Forum | Delete Category</title>
    <!-- ///////////////////////////////////////////// -->
    <meta charset="utf-8">
...
<!-- /////////////////////////////////////// -->	
				...
				<div class="content">
					...
					{
						if($con->query('delete from categories where id="'.$id.'"') and $con->query('delete from topics where parent="'.$id.'"') and $con->query('update categories set position=position-1 where position>"'.$dn1['position'].'"'))
						{
							?>
